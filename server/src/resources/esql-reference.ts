...
function loadEsqlDocs(): Map<string, string[]> {
  ...
  const order: Array<{ category: string; prefixes: string[] }> = [
    { category: 'Overview & Syntax', prefixes: ['esql-overview', 'esql-syntax', 'esql-operators', 'esql-binary operators', 'esql-logical operators'] },
    { category: 'Source Commands', prefixes: ['esql-from', 'esql-row', 'esql-show'] },
    { category: 'Processing Commands', prefixes: ['esql-where', 'esql-eval', 'esql-stats', 'esql-stats-by', 'esql-inlinestats-by', 'esql-sort', 'esql-limit', 'esql-keep', 'esql-drop', 'esql-rename', 'esql-dissect', 'esql-grok', 'esql-enrich', 'esql-fork', 'esql-mv_expand'] },
    { category: 'Aggregation Functions', prefixes: ['esql-count', 'esql-sum', 'esql-avg', 'esql-min', 'esql-max', 'esql-median', 'esql-percentile', 'esql-count_distinct', 'esql-values', 'esql-top', 'esql-std_dev', 'esql-weighted_avg'] },
    { category: 'Date & Time Functions', prefixes: ['esql-bucket', 'esql-date_format', 'esql-date_diff', 'esql-date_extract', 'esql-date_trunc', 'esql-now'] },
    { category: 'String Functions', prefixes: ['esql-concat', 'esql-substring', 'esql-trim', 'esql-ltrim', 'esql-rtrim', 'esql-to_lower', 'esql-to_upper', 'esql-length', 'esql-split', 'esql-replace', 'esql-starts_with', 'esql-ends_with'] },
    { category: 'Type Conversion', prefixes: ['esql-to_string', 'esql-to_integer', 'esql-to_long', 'esql-to_double', 'esql-to_datetime', 'esql-to_boolean'] },
    { category: 'Conditional Functions', prefixes: ['esql-case', 'esql-coalesce', 'esql-greatest', 'esql-least'] },
    { category: 'Math Functions', prefixes: ['esql-round', 'esql-ceil', 'esql-floor', 'esql-abs', 'esql-pow', 'esql-sqrt', 'esql-log', 'esql-log10', 'esql-pi'] },
    { category: 'Multi-Value Functions', prefixes: ['esql-mv_count', 'esql-mv_concat', 'esql-mv_contains', 'esql-mv_first', 'esql-mv_last'] },
